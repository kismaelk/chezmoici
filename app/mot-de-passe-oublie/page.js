...
import { reinitialiserMotDePasse } from '@/lib/auth'
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 w-full max-w-md">
          {envoye ? (
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-[#1B5E20] mb-3">Courriel envoyé !</h1>
            ...
            <>
              <h1 className="text-2xl font-bold text-[#1B5E20] mb-1">Mot de passe oublié ?</h1>
              <p className="text-gray-500 mb-6 text-sm">
                Entre ton adresse courriel et on t&apos;envoie un lien pour réinitialiser ton mot de passe.
              </p>
              ...
              <a href="/connexion" className="block text-center text-gray-500 mt-4 text-sm hover:underline">
                ← Retour à la connexion
              </a>
            </>
          )}
